...
#undef PREP
    ...
    #define PREP_RECOMPILE_START    if (isNil "duic_fnc_recompile") then {duic_recompiles = []; duic_fnc_recompile = {{call _x} forEach duic_recompiles;}}; private _recomp = {
    #define PREP_RECOMPILE_END      }; call _recomp; duic_recompiles pushBack _recomp;
#else
